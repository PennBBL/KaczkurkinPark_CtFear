...
Limbic<-ggplot() +
  ...
  theme(axis.title=element_text(size=30,face="bold"), axis.text=element_text(size=20), axis.title.x=element_text(color = "#F58311"), axis.title.y=element_text(color = "black"))
